    ...
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10 bg-gray-100">
            ...
            <form method="POST" action="\register" class="mt-10">
                ...
                <div class="mb-6">
                    <label for="username" class="block mb-2 uppercase text-xs font-bold text-gray-700">
                        Username
                    </label>
                    <input class="border border-gray-400 p-2 w-full"
                            type="text"
                ...
                <div class="mb-6">
                    <label for="email" class="block mb-2 uppercase text-xs font-bold text-gray-700">
                        Email
                    </label>
                    <input class="border border-gray-400 p-2 w-full"
                            type="email"
                ...
                <div class="mb-6">
                    <label for="password" class="block mb-2 uppercase text-xs font-bold text-gray-700">
                        Password
                    </label>
                    <input class="border border-gray-400 p-2 w-full"
                            type="password"
